...
use Logicalcrow\ReCaptcha\Facades\ReCaptcha;

if (!function_exists('recaptcha')) {
    /**
     * @return \Logicalcrow\ReCaptcha\ReCaptchaBuilder
     */
    function recaptcha(): \Logicalcrow\ReCaptcha\ReCaptchaBuilder
    {
...
if (!function_exists('recaptchaRuleName')) {
    ...
    function recaptchaRuleName(): string
    {
        ...
        return \Logicalcrow\ReCaptcha\ReCaptchaBuilder::DEFAULT_RECAPTCHA_RULE_NAME;
    }
}
...
if (!function_exists('recaptchaFieldName')) {
    ...
    function recaptchaFieldName(): string
    {
        ...
        return \Logicalcrow\ReCaptcha\ReCaptchaBuilder::DEFAULT_RECAPTCHA_FIELD_NAME;
    }
}
