...
namespace Logicalcrow\ReCaptcha;

use Logicalcrow\ReCaptcha\Exceptions\InvalidConfigurationException;
use Illuminate\Support\Arr;

/**
 * Class ReCaptchaBuilderV2
 * @package Logicalcrow\ReCaptcha
 */
class ReCaptchaBuilderV2 extends ReCaptchaBuilder
{
    ...
    public function getOnLoadCallback(): string
    {
        ...
        return "<script>var logicalcrowOnloadCallback = function() {grecaptcha.render('recaptcha-element', " . json_encode($attributes) . ");};</script>";
    }
